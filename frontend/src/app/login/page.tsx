...
import { login, getStoredToken } from "../../lib/api";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    // If token exists already, go straight to learn page
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      <div className="max-w-md w-full border-2 border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-bold">Log in to start learning Spanish</p>
        </div>
      ...
      {/* Quick Seed Hint for Evaluators */}
      <div className="mt-6 text-center max-w-sm bg-gray-50 border border-gray-200 rounded-xl p-3 text-xs text-gray-500 font-bold">
        💡 Evaluator Hint: You can sign in using the seeded test user:
        <div className="mt-1">
          Username: <span className="font-mono text-gray-700 font-extrabold">duo_learner</span>
          <br />
          Password: <span className="font-mono text-gray-700 font-extrabold">password123</span>
        </div>
      </div>
    </div>
  );
